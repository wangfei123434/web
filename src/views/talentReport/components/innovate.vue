...
（项目名称、进度计划、绩效预期等）
3、重要成果
（代表性论著<论文>，仅填一作（共同一作）或通讯作者的，并注明影响因子；专利）
4、重要奖项
（在专业领域获得的较大影响力的奖项）"
        ></el-input>
      </el-form-item>
...
（在专业领域获得的较大影响力的奖项）"
      ...
      <el-form-item  label="能证明近三年从市外引进到举荐单位的佐证材料：" class="customUpLoad" prop="workAtta">
        <el-button
        ...
        <el-input
          ...
          placeholder="工作合同复印件、引进时间节点前后半年、横跨两个单位的社保或纳税凭据"
        ></el-input>
      </el-form-item>
      <el-form-item
        label="其他奖励证书复印件:"
    ...
    submit() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          if(cityEnterpriseType && (cityEnterpriseType == 3 || cityEnterpriseType == 2)) {
