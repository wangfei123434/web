<template>
  ...
  <div class="content-wrapper">
    <div class="main">
      <div class="head">{{ title | applyTypeFR }}-在线申报</div>
      <div class="body">
        <div class="left">
        ...
        <div class="right">
          <div class="tabContent" v-if="curTab == 1">
            ...
            <div
              class="content"
              style="padding: 0px 20px 0px 140px; text-align: left"
            >
              <p>1.填写前请认真阅读《青山英才（钢城工匠）申报指引》。</p>
              <p>
                2.请按要求填写完整、全面、真实信息，不得空项、漏项，若无相关信息，请填写“无”。
              </p>
              <p>
                3.联系人、联系电话、电子邮箱：联系人应为具体负责办理申报事宜的工作人员，熟悉申报人、申报材料的相关情况，可以为申报人本人。联系电话请同时填写办公电话和手机号码，保证联系畅通。
              </p>
              <p>4.照片：为近期两寸正面免冠证件照（红底）。</p>
              <p>5.身份证件：指居民身份证或护照等有效身份证件及其号码。</p>
              <p>
                6.最高学历、学位、毕业院校及专业：填写申报人所获最高学历（学位）的毕业院校、专业及学位的全称。
              </p>
              <p>
                7.工作单位、职务（岗位）：指申报人目前工作关系所在单位及其现任职务（岗位），以社保关系为准，单位名称需填写规范全称。
              </p>
              <p>
                8申报人诚信承诺：申报人承诺填报的所有信息均真实有效，若有弄虚作假行为，取消本次入选资格和今后三年的申报资格，并承担相应的法律责任。后期纸质材料须由申报人亲笔签名，不得由他人代签。
              </p>
              <p>
                9.用人单位意见：由申报人所在单位对申报人各项条件进行审查，对符合条件的人选作出意见。
              </p>
            </div>
            <hr />
            <div class="foot">
          ...
          <div class="tabContent tabContent2" v-else-if="curTab == 2">
            ...
            >
              ...
              <el-form-item label="户籍所在地:" prop="nationality">
                <el-input
              ...
              <el-form-item label="工作岗位:" prop="technicalPosition">
                <el-input
                  v-model="form.technicalPosition"
                  placeholder="工作岗位"
                ></el-input>
              </el-form-item>
              <el-form-item label="行政（社会）职务:">
                <el-input
                  v-model="form.socialFunction"
                  placeholder="行政（社会）职务"
                ></el-input>
              </el-form-item>
              <el-form-item label="职业（工种）名称:" prop="techTitle">
                <el-input
                  v-model="form.techTitle"
                  placeholder="职业（工种）名称"
                ></el-input>
              </el-form-item>
              <el-form-item label="职业资格等级:" prop="qualificationsGrade">
                <el-input
                  v-model="form.qualificationsGrade"
                  placeholder="职业资格等级"
                ></el-input>
              </el-form-item>
              <el-form-item label="证书编号:" prop="qualificationsNumber">
                <el-input
                  v-model="form.qualificationsNumber"
                  placeholder="证书编号"
                ></el-input>
              </el-form-item>
              <el-form-item label="本工种工龄:" prop="workTime">
                <el-input
                  v-model="form.workTime"
                  placeholder="本工种工龄"
                ></el-input>
              </el-form-item>
              <el-form-item label="参加工作时间:" prop="currentPostDate">
                <el-date-picker
              ...
              <hr />
              <el-form-item label="培养技能人才情况:" prop="companyTotalCount">
                <div class="item">
                  <span>培养学徒总数 </span>
                  <el-input
                    v-model="form.companyTotalCount"
                    placeholder="0"
                    style="width: 100px; margin-right: 10px"
                  ></el-input>
                  <span>其中：已成为技术骨干的有 </span>
                  <el-input
                    v-model="form.compRegularCount"
                    placeholder="0"
                    style="width: 100px; margin-right: 10px"
                  ></el-input>
                  <span>取得市级以上优异成绩的有 </span>
                  <el-input
                    v-model="form.compMasterCount"
                    placeholder="0"
                    style="width: 100px; margin-right: 10px"
                  ></el-input>
                </div>
...
19XX年7月-20XX年X月 中国 XXXX有限公司XX部门XX项目组负责人"
              ...
              <el-form-item label="获得过何种荣誉和奖励:" prop="honor">
                <el-input
                  type="textarea"
                  v-model="form.honor"
                  :rows="5"
                  placeholder="按时间顺序，包括“时间、颁发部门、奖励名称
如：
20XX年X月  XXXX部门获XXXX奖项"
                ></el-input>
              </el-form-item>
              <el-form-item label="获得的发明专利及专利号:">
                <el-input
                  type="textarea"
                  v-model="form.achievement"
                  :rows="5"
                  placeholder="按时间顺序，包括“时间、专利名称、专利种类及成果转化情况”
如：
20XX年X月  XXXX专利名称 XXXX专利种类
成果转化情况：（有就填写，没有填“无”）"
                ></el-input>
              </el-form-item>
              <el-form-item label="职业技能竞赛获奖情况:">
                <el-input
                  type="textarea"
                  v-model="form.memo"
                  :rows="5"
                  placeholder="按时间顺序，包括“时间、颁发部门、竞赛名称、竞赛名次”
如：
20XX年X月  获XXXX部门XXXX大赛 XXXX奖项"
                ></el-input>
              </el-form-item>
              <el-form-item label="主要业绩、成果和贡献:">
                <el-input
                  type="textarea"
                  v-model="form.contrib"
                  :rows="5"
                  placeholder="（500字以内，条目式表述）主要从工匠精神、技能技艺、业绩成果（包括产生的经济、社会效益）等方面进行总结。"
                ></el-input>
              </el-form-item>
              <el-form-item
                label="未来三年工作设想:"
...
拟开展的研究工作应有创新性构思，可包括研究方向（领域）、意义、国内外概况、研究内容、技术路线、最终成果形式（包括实物、软件、论文、专著等）及达到的水平等。"
              ...
              <!-- 附件 -->
              <cyApply3
                v-if="title == 'qs_qingshanElite_craftsman' || title == 'gcjj2'"
                :type="title"
                :data="attachmentReqDTOS"
                ref="attachmentRef"
                @setDelArr="setDelArr"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        workTime: [{ required: true, message: "请输入内容", trigger: "blur" }],
  ...
  methods: {
    queryData() {
      ...
      if (!id) {
        ...
        f.compName = this.$route.query.companyName;
        ...
        getCompany({
          ...
          if (res?.code == 200) {
            ...
            f.compFax = c.fax;
            f.compName = c.name;
            f.companyFinance = c.finance;
            f.companyValuation = c.valuation;
            f.companyRegisterCapital = c.registerCapital;
            f.companyTotalCount =c?.talentOther?.totalCount || 0;
            f.compRegularCount =c?.talentOther?.skillCount || 0;
            f.compMasterCount =c?.talentOther?.excellentCount || 0;
            f.companyId = c.id;
          }
        });
      ...
      getTalentData(url).then((res) => {
        ...
        if (d) {
          ...
          f.idType =
            d.idName == "身份证" || d.idName == "护照" ? d.idName : "其他";
          f.idTypeText =
            f.idType == "身份证" || f.idType == "护照" ? "" : d.idName;
          ...
          f.future = d.future;
          f.entre = d.entre || "";
          f.socialFunction = d.socialFunction;
          f.techTitle = d.techTitle;
          f.qualificationsGrade = d.qualificationsGrade;
          f.qualificationsNumber = d.qualificationsNumber;
          f.workTime = d.workTime;
          f.currentPostDate = d.currentPostDate;
          f.address = d.address;
          f.honor = d.honor;
          f.memo = d.memo;
          ...
          f.compName = this.$route.query.companyName;
          f.companyId = d?.talentOther?.id;
          f.companyTotalCount = d?.talentOther?.totalCount || 0;
          f.compRegularCount = d?.talentOther?.skillCount || 0;
          f.compMasterCount = d?.talentOther?.excellentCount || 0;
          ...
          if (attachmentReqDTOS) {
            ...
            if (headAtta.length > 0) {
              this.form.header = headAtta[0].url;
    ...
    getParam(operationType) {
      ...
      formData.append(
        "id",
        this.$route.query.talentId ? this.$route.query.talentId : ""
      );
      formData.append("operationType", operationType);
      ...
      formData.append("socialFunction", this.form.socialFunction);
      formData.append("techTitle", this.form.techTitle);
      formData.append("qualificationsGrade", this.form.qualificationsGrade);
      formData.append("qualificationsNumber", this.form.qualificationsNumber);
      formData.append("workTime", this.form.workTime);
      formData.append("address", this.form.address);
      formData.append("honor", this.form.honor);
      formData.append("memo", this.form.memo);

      // 公司
      formData.append("companyName", this.form.compName);
      formData.append("companyReqDTOs[0].address", this.form.companyAddress);
      formData.append("companyReqDTOs[0].phone", this.form.compPhone);
      formData.append("companyReqDTOs[0].fax", this.form.compFax);
      formData.append("companyReqDTOs[0].name", this.form.compName);
      // formData.append("companyReqDTOs[0].finance", this.form.companyFinance);
      // formData.append("companyReqDTOs[0].valuation", this.form.companyValuation);
      // formData.append("companyReqDTOs[0].registerCapital", this.form.companyRegisterCapital);
      formData.append("talentOther.totalCount", this.form.companyTotalCount);
      formData.append("talentOther.skillCount", this.form.compRegularCount);
      formData.append("talentOther.excellentCount", this.form.compMasterCount);
      formData.append("talentOther.id", this.form.companyId);

      // 附件
      this.personImgData &&
        !this.personImgData.id &&
