...
拟开展的研究工作应有创新性构思，可包括研究方向（领域）、意义、国内外概况、研究内容、技术路线、最终成果形式（包括实物、软件、论文、专著等）及达到的水平等。"
              ...
              <!-- <hr> -->
              <el-form-item label="是否为创始人或合伙人:">
                <el-radio-group v-model="form.isFounder">
                  <el-radio label="1">是</el-radio>
                  <el-radio label="0">否</el-radio>
                </el-radio-group>
              </el-form-item>
              <!-- <el-form-item label="创办企业名称:">
                <el-input v-model="form.compName" placeholder="创办企业名称" disabled></el-input>
              </el-form-item>
              <el-form-item label="工作单位地址:" prop="companyAddress">
                <el-input v-model="form.companyAddress"  placeholder="工作单位地址" disabled></el-input>
              </el-form-item>
              <el-form-item label="单位电话:" prop="companyTel">
                <el-input v-model="form.companyTel"  placeholder="单位电话" disabled></el-input>
              </el-form-item>
              <el-form-item label="单位传真:">
                <el-input v-model="form.companyFax"  placeholder="单位传真" disabled></el-input>
              </el-form-item>
              <el-form-item label="融资情况:">
                <el-input v-model="form.companyFinance"  placeholder="融资情况" disabled></el-input>
              </el-form-item>
              <el-form-item label="企业估值（万元）:">
                <el-input v-model="form.companyValuation"  placeholder="0" disabled></el-input>
              </el-form-item>
              <el-form-item label="融资金额实际到位情况（万元）:">
                <el-input v-model="form.companyRegisterCapital"  placeholder="0" disabled></el-input>
              </el-form-item>
              <el-form-item label="吸纳就业人数情况:">
                <el-input v-model="form.companyTotalCount"  placeholder="0" disabled></el-input>
              </el-form-item> -->
              <!-- <hr> -->

              <!-- 附件 -->
              <cyApply2
                v-if="title == 'qs_excellentYouth_startup'"
                :type="title"
...
export default {
  ...
  methods: {
      ...
      if (!id) {
        ...
        getCompany({
          ...
          if (res?.code == 200) {
            ...
            f.companyValuation = c.valuation || 0;
            f.companyRegisterCapital = c.registerCapital || 0;
            f.companyTotalCount = c.totalCount || 0;
            f.companyId = c.id;
          }
        });
    ...
    getParam(operationType) {
      ...
      formData.append(
        "techTitle",
        this.form.socialPosition == "有"
          ? this.form.socialPositionText
          : this.form.socialPosition
      );
      ...
      formData.append("isFounder", this.form.isFounder);
      ...
      formData.append(
        "companyReqDTOs[0].valuation",
        this.form.companyValuation
      );
      formData.append(
        "companyReqDTOs[0].registerCapital",
        this.form.companyRegisterCapital
      );
      formData.append(
        "companyReqDTOs[0].totalCount",
        this.form.companyTotalCount
      );
