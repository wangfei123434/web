<template>
  ...
  <div class="form">
    ...
    >
      ...
      <!-- <el-form-item label="推荐创投机构（知名创业投资人）：" prop="investName">
      ...
      <div>
        ...
        <!-- 在汉纳税人数 2022-08-25新增 -->
        <el-form-item label="在汉纳税人数：" prop="taxpayerCount">
          <el-input
            :disabled="disabled"
            v-model.number="form.taxpayerCount"
          ></el-input>
        </el-form-item>
      ...
      <el-form-item label="企业及创业项目简介：" prop="memo">
        <el-input
          :disabled="disabled"
          maxlength="200"
          type="textarea"
      ...
      <el-form-item label="知名投资机构投资情况：" prop="ainvest">
        <el-input
          :disabled="disabled"
          type="textarea"
          v-model="form.ainvest"
          :rows="5"
          placeholder="（投资机构名称、投资时间、投资额、占股情况等）"
        ></el-input>
        <!-- <quill-editor
          v-model="form.ainvest"
          ref="myQuillEditor3"
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        memo: [{ required: true, message: "请输入", trigger: "blur" }], //企业及创业项目简介
        ainvest: [{ required: true, message: "请输入", trigger: "blur" }], //知名投资机构投资情况
...
::v-deep .customUpLoad .el-form-item__label{
