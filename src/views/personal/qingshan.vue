        ...
        <div class="right">
          <div class="tabContent" v-if="curTab == 1">
            ...
            >
              ...
              <p>
                <span style="font-size:10.5pt"
                  >8.申报人诚信承诺：申报人承诺填报的所有信息均真实有效，若有弄虚作假行为，取消本次入选资格和今后三年的申报资格，并承担相应的法律责任。后期纸质材料须由申报人亲笔签名，不得由他人代签。</span
                >
              </p>
              <p>
                <span style="font-size:10.5pt"
                  >9.用人单位意见：由申报人所在单位对申报人各项条件进行审查，对符合条件的人选作出意见。</span
                >
              </p>
              <p>
                <span style="font-size:10.5pt"
                  >10.主管部门意见：申报人所在单位的主管部门对照申报条件，提出意见。</span
                >
              </p>
            </div>
            <hr />
...
19XX年7月-20XX年X月 中国 XXXX有限公司XX部门XX项目组负责人"
              ...
              <!-- <el-form-item label="工作单位:" prop="company">
                <el-input v-model="form.company" disabled placeholder="工作单位"></el-input>
              </el-form-item>
              <el-form-item label="工作单位地址:" prop="companyAddress">
                <el-input v-model="form.companyAddress" disabled placeholder="工作单位地址"></el-input>
              </el-form-item>
              <el-form-item label="单位电话:" prop="companyTel">
                <el-input v-model="form.companyTel" disabled placeholder="单位电话"></el-input>
              </el-form-item>
              <el-form-item label="单位传真:">
                <el-input v-model="form.companyFax" disabled placeholder="单位传真"></el-input>
              </el-form-item>
              ...
              <!-- 附件 -->
              <cyApply1 
                v-if="title == 'qs_leaders_innovation' || title == 'qs_leaders_startup'" 
      ...
      if(!id) {
        ...
        getCompany({
          ...
          if(res?.code == 200) {
            ...
            f.agoSale = c.agoSale
            f.blastSale = c.blastSale
            f.lastSale = c.lastSale
            f.agoProfit = c.agoProfit
            f.blastProfit = c.blastProfit
            f.lastProfit = c.lastProfit
            f.agoDev = c.agoDev
            f.blastDev = c.blastDev
            f.lastDev= c.lastDev
            f.agoTax = c.agoTax
            f.blastTax = c.blastTax
            f.lastTax = c.lastTax
            f.memo = c.memo
            f.idea = c.idea
          }
