    ...
    <div class="w-1200-auto content-wrapper-body">
      ...
      <div class="content">
            ...
            <el-tab-pane label="武汉英才" name="first">
              <table cellspacing="0">
                ...
                <tr v-for="(o, i) in cityRecommendList" :key="i">
                  <td>{{ o.dateCreated&&o.dateCreated.slice(0,4) }}</td>
                  <!-- <td>{{ o.shixiang }}</td> -->
                  <td>武汉英才</td>
                  ...
                  <td class="btns">
                    ...
                    >反馈信息222</span
                    > -->
                    <span class="mr20" @click="toRecommend(o)">
                      <span class="btn" v-if="o.dateCreated&&o.dateCreated.slice(0,4) == (new Date()).getFullYear()">
                        <span v-if="o.status == 0 || o.status == 4">修改</span>
                        <span v-else-if="o.status == null">去认定</span>
                        <span v-else>查看</span>
                      </span>
                      <span class="btn" v-else>查看</span>
                    </span>
        ...
        <div class="right" v-show="visible" style="text-align: left">
                ...
                <div class="itemBox">
                  <div class="item">
                    ...
                    >
                      ...
                      <el-radio label="国家重点实验室以及有国家重点实验室的高校院所"></el-radio>
                      <el-radio label="湖北实验室"></el-radio>
                      <!-- <el-radio label="湖北实验室/国家重点实验室/新型研发机构"></el-radio> -->
                      <el-radio label="高校科研院所"></el-radio>
                    </el-radio-group>
                  </div>
          ...
          <hr />
          <unVenture
            v-if="type == '企事业单位' && type1 == '非创投机构推荐' && thisFrom"
            :type="type"
            :type1="type1"
            :isShowBtn="isShowBtn"
            :thisFrom="thisFrom"
          ...
          <venture
            ...
            :isShowBtn="isShowBtn"
            :thisFrom="thisFrom"
            v-else-if="type == '企事业单位' && type1 == '创投机构推荐' && thisFrom"
            @recommendSaveEdit="recommendSaveEdit"
          ></venture>
          <other
            v-else
...
export default {
  ...
  methods: {
    ...
    toRecommend(o) {
      ...
      if(o.cityEnterpriseType == 1){
        if(o.representType == 1){
          this.type1 = "创投机构推荐"
        }else{
          this.type1 = "非创投机构推荐"
        }
        this.type = "企事业单位"
      }else if(o.cityEnterpriseType == 2){
        this.type = "国家重点实验室以及有国家重点实验室的高校院所"
      }else if(o.cityEnterpriseType == 3){
        this.type = "湖北实验室"
      }else if(o.cityEnterpriseType == 4){
        this.type = "高校科研院所"
      }
      if(o.dateCreated&&o.dateCreated.slice(0,4) == (new Date()).getFullYear()){
        this.isShowBtn = true
      }else{
        this.isShowBtn = false
      }
      this.setComponyInfo(o);
      this.thisFrom = o
      this.visible = true;
    },
    // 获取公司数据
    ...
    async getQingshanListFun(){
      ...
      if(res.code == 200){
        ...
        this.cityRecommendList = res.data
      }
    }
  },
};
  ...
  .top {
    ...
    .top-right {
      ...
      .top-box {
        display: flex;
        & > span {
          background: rgba(206,234,255,0.3900);
          width: 70px;
          height: 24px;
